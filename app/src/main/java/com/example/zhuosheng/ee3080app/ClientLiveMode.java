...
public class ClientLiveMode extends AsyncTask<Void, Void, String> {
        String dstAddress;
...
private PostTaskListener<String> postTaskListener;
        ...
        ClientLiveMode(PostTaskListener<String> postTaskListener, String addr, int port, Bitmap bmp, int TO) {
        dstAddress = addr;
        dstPort = port;
        timeout = TO;
        this.bmp = bmp;
