      ...
      if (!prefManager.isFirstTimeLaunch()&& !turnOnTutorial) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int current = getItem(+1);//current item is now the next page
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == layouts.length - 1) {
                ...
                btnNext.setText(getString(R.string.start));//change the btnText to id@start in String Value (equals to "GOT IT")
